...
class JMapInvoker(
    ...
    private val calls = mutableListOf<Triple<String,  Map<String, JsonElement>, CompletableDeferred<JMapCallResult>>>()

    suspend fun doCall(method: String, arguments: Map<String, JsonElement>, usingUrn: String): JMapCallResult {
